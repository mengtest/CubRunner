...
public static class NguiUtils
{
	...
	public static void SetVisible(Transform transform, bool visible)
	{
		SetNguiVisible(transform, visible);
...
//			}
	...
	private static void SetNguiVisible(Transform transfom, bool visible)
	{
